...
vector < vector <float> > blur(vector < vector < float> > grid, float blurring) {
	...
	//vector<float> newRows;
		...
		//To calculate blurring factor for cells
	float probability_center = 1.0 - blurring;
	float probability_corner = blurring/12.0;
	float probability_adjacent = blurring/6.0; 
	...
	vector <vector <float>> window = {
		{probability_corner,probability_adjacent,probability_corner},
		{probability_adjacent,probability_center,probability_adjacent},
		{probability_corner,probability_adjacent,probability_corner},
	};
